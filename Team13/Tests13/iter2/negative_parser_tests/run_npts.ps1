...
Invoke-Expression -Command "autotester.exe iter2_empty_proc_source.txt empty_queries.txt out.xml"
...
Invoke-Expression -Command "autotester.exe iter2_source_with_invalid_token.txt empty_queries.txt out.xml"
